...
import UserManagement from "./pages/admin/UserManagement";
import ProductPublish from "./pages/admin/ProductPublish";
import ProductManagement from "./pages/admin/ProductManagement"; // Make sure this is correct
import AdminLogin from "./pages/admin/AdminLogin";
import Logout from "./pages/admin/Logout";
import AdminPrivateRoute from "./pages/admin/components/AdminPrivateRoute";
import UpdateProductForm from "./pages/admin/UpdateProductForm";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        {/* Admin Product View Route (if you want a separate page) */}
        <Route
          path="/admin/product/:id"
          element={
            <AdminPrivateRoute>
              {/* You can create a separate ProductDetailPage for admin if needed */}
              <ProductDetailPage />
            </AdminPrivateRoute>
          }
        />
